...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <td>{{DB::table('mahasiswa')->where('id', $k['id'])->value('nim')}}</td>
            <td>@php echo $k['tahun_kp'] @endphp</td>
            <td>
            <a href="/ujian/jadwal/{{ $k['id_kp'] }}" class="btn btn-success">Set Ujian</a>
            </td>
            </tr>
        </tbody>
        @endforeach
