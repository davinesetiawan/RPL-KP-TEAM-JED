...
<form action="/prakp/updated/" method="post" enctype='multipart/form-data'>
    @csrf
    @method ('PUT')
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" name="wkt_pel_kp" id="wkt_pel_kp" value="{{ $pkp->wkt_pel_kp }}">
    </div>
    <div class="form-group">
